// src/app/pages/example/list.example.js
...
export class list extends StatefulWidget {
    ...
    inpage = 10;
    page = 1;
    linker = "console_folder_s";

    before_render() {
        let userId = getLocalUserId();
        GetCompositionListListener("the_phonebook", userId, this.inpage, this.page, NORMAL).subscribe((output) => {
